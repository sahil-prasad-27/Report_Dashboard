...
#include "../Report_Window/graph_factory/lineChart.h"
...
QT_MOC_LITERAL(1, 10, 11), // "showToolTip"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 36, 5) // "event"

    },
    "LineChart\0showToolTip\0\0QMouseEvent*\0"
    "event"
};
...
void LineChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showToolTip((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject LineChart::staticMetaObject = { {
    &GraphCustomPlot::staticMetaObject,
...
void *LineChart::qt_metacast(const char *_clname)
{
    ...
    return GraphCustomPlot::qt_metacast(_clname);
}

int LineChart::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GraphCustomPlot::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
